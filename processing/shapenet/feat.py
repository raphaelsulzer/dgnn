...
if __name__ == "__main__":
    ...
    parser.add_argument('-d', '--dataset_dir', type=str, default="/mnt/raphael/ShapeNetManifoldPlus/",
    ...
    for i,c in enumerate(categories):
        ...
        ### train
        args.input = os.listdir(os.path.join(args.dataset_dir, c, "3_scans"))
